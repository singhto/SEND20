...
class MyDeliveryShopOrder extends StatefulWidget {
  @override
  _MyDeliveryShopOrderState createState() => _MyDeliveryShopOrderState();
}

class _MyDeliveryShopOrderState extends State<MyDeliveryShopOrder> {
  // Field
