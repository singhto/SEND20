...
class HaveProblem extends StatefulWidget {
  @override
  HaveProblemState createState() => HaveProblemState();
}

class HaveProblemState extends State<HaveProblem> {
  double lat;
  double lng;
  double currentLat;
  double currentLng;
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                  'การเชื่อมต่อสัญญาณ Internet มีปัญหา',
                  style: TextStyle(
                    fontSize: 20.0,
            ...
            child: Align(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    child: IconButton(
                      icon: Icon(Icons.wifi_lock, color: Colors.white),
                      onPressed: () {
                        AppSettings.openWIFISettings();
                      },
                    ),
